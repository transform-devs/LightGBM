...
def test_e2e(params, rank_data_with_header, trained_model_path):
...
@pytest.mark.parametrize("data_params", [{"transform_file": simple_ds.transform}, {"header_file": simple_ds.header}])
@pytest.mark.skipif(not has_transform_lib_installed(), reason="requires transform lib to be installed")
